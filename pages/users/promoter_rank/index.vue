			...
			<view class="redBg bg-color">
				<view class="header">
					<view class="nav acea-row row-center-wrapper">
						<view class="item" :class="active == index ? 'font-color-violet' : ''" v-for="(item,index) in navList" :key="index"
...
<style scoped lang="scss">
	...
	.PromoterRank .header .nav .item.font-color-violet:nth-of-type(1) {
		background-color: #fff;
		border-radius: 33rpx 0 0 33rpx;
	}

	.PromoterRank .header .nav .item.font-color-violet:nth-of-type(2) {
		background-color: #fff;
