<template>
	<view>
		<view class='payment-status'>
			...
			<view class='iconfont icons icon-duihao2 bg-color-orange' v-if="order_pay_info.paid || order_pay_info.pay_type == 'offline'"></view>
			<view class='iconfont icons icon-iconfontguanbi fail' v-else></view>
			<!-- 失败时：订单支付失败 -->
			...
			<view class="coupons" v-if='couponList.length'>
				...
				<view class="list">
					...
					<view class="open acea-row row-center-wrapper" @click="openTap">{{couponsHidden?'展开':'收起'}}<text class="iconfont" :class='couponsHidden==true?"icon-xiangxia":"icon-xiangshang"'></text></view>
				</view>
			</view>
		</view>
		<!-- #ifdef MP -->
...
<style lang="scss">
	...
	.payment-status .icons {
		...
		text-align: center;
		line-height: 140rpx;
		text-shadow: 0px 4px 0px rgba(255, 165, 8, 0.5);
